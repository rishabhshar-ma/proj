                            ...
                            <div className="col-lg-12">
                                <div className="page-banner text-center">
                                    ...
                                    <ul className="breadcrumb justify-content-center">
                                        ...
                                        <li className="breadcrumb-item"><a href="/user/home">User</a></li>
                                                    ...
                                                    <div className="single-blog">
                                                        ...
                                                        <div className="blog-content">
                                                            ...
                                                            <div className="blog-btn">
                                                                <Link className="blog-btn-link" to={`/user/blog-details-user/${blog_id}`}>Read Full Blog<i className="fas fa-long-arrow-alt-right"></i></Link>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
